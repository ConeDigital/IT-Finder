...
jQuery(document).ready(function() {
    ...
    */
    $('.page-title').backstretch("assets/img/banner_bg.jpg");
    $('.counters-container').backstretch("assets/img/banner_bg.jpg");
    $('.our-motto-container').backstretch("assets/img/banner_bg.jpg");
    $('.call-to-action-container').backstretch("assets/img/banner_bg.jpg");
